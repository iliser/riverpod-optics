...
class TextFieldL<T> extends ConsumerStatefulWidget {
  ...
  final RiverpodLens<T, String> lens;
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _TextFieldLState();
}

class _TextFieldLState extends ConsumerState<TextFieldL> {
  late final TextEditingController controller =
      TextEditingController(text: lens.value)
        ..addListener(() => lens.change(controller.text));

  late FocusedLens<String> lens;
  ...
  Widget build(BuildContext context) {
    lens = RiverpodLens.focus(widget.lens, ref);
